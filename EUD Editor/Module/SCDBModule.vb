Module SCDBModule
    Public Function ToScdbeps() As String
        ...
        strbulider.AppendLine("    ){")
        strbulider.AppendLine("        switch(Status[getcurpl()]) {")
