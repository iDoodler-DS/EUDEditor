Module SCDBModule
    Public Function ToScdbeps() As String
        ...
        strbulider.AppendLine("                    tct.chatAnnouncement(""" & Lan.GetMsgText("scdbNoDataFile") & """);")
        strbulider.AppendLine("                }")
        ...
        strbulider.AppendLine("    if(customMessage == 0) {")
        strbulider.AppendLine("        tct.chatAnnouncement(""" & Lan.GetMsgText("scdbLoading") & """);")
        strbulider.AppendLine("    }")
        ...
        strbulider.AppendLine("            tct.chatAnnouncement(""" & Lan.GetMsgText("scdbLoaded") & """);")
        strbulider.AppendLine("        }")
        ...
        strbulider.AppendLine("        if(customMessage == 0) {")
        strbulider.AppendLine("            PlayWAV(""sound\\misc\\outofgas.wav"");")
        strbulider.AppendLine("            tct.chatAnnouncement(""" & Lan.GetMsgText("scdbDisconnected") & """);")
        strbulider.AppendLine("        }")
        ...
        strbulider.AppendLine("    LastStatus[cp] = 6;")
        strbulider.AppendLine("    if(customMessage == 0) {")
        strbulider.AppendLine("        tct.chatAnnouncement(""" & Lan.GetMsgText("scdbSaving") & """);")
        strbulider.AppendLine("    }")
        ...
        strbulider.AppendLine("            if(customMessage == 0) {")
        strbulider.AppendLine("                PlayWAV(""sound\\misc\\tdrtra00.wav"");")
        strbulider.AppendLine("                tct.chatAnnouncement(""" & Lan.GetMsgText("scdbSaved") & """);")
        strbulider.AppendLine("            }")
        ...
        strbulider.AppendLine("    if(customMessage == 0) {")
        strbulider.AppendLine("        tct.chatAnnouncement(""" & Lan.GetMsgText("scdbWaiting") & """, Ping[cp], """");")
        strbulider.AppendLine("    }")
        strbulider.AppendLine("    ReadPacket();")
        strbulider.AppendLine("")
        ...
        strbulider.AppendLine("                tct.chatAnnouncement(""" & Lan.GetMsgText("scdbConnected") & """);")
        strbulider.AppendLine("            }")
        ...
        strbulider.AppendLine("        if(customMessage == 0) {")
        strbulider.AppendLine("            PlayWAV(""sound\\misc\\outofgas.wav"");")
        strbulider.AppendLine("            tct.chatAnnouncement(""" & Lan.GetMsgText("scdbLauncherNotFound") & """);")
        strbulider.AppendLine("        }")
        strbulider.AppendLine("        const inits = list(SetMemoryEPD(mainAddressEPD - 1, SetTo, 0));")
        strbulider.AppendLine("        foreach(n : py_range(8)) {")
        strbulider.AppendLine("            inits.append(SetMemoryEPD(mainAddressEPD + n, SetTo, 1));")
        ...
        strbulider.AppendLine("        if(customMessage == 0) {")
        strbulider.AppendLine("            PlayWAV(""sound\\misc\\outofgas.wav"");")
        strbulider.AppendLine("            tct.chatAnnouncement(""" & Lan.GetMsgText("scdbForceDisconnected") & """);")
        strbulider.AppendLine("        }")
        strbulider.AppendLine("        const inits = list(SetMemoryEPD(mainAddressEPD - 1, SetTo, 0));")
        strbulider.AppendLine("        foreach(n : py_range(8)) {")
        strbulider.AppendLine("            inits.append(SetMemoryEPD(mainAddressEPD + n, SetTo, 1));")
