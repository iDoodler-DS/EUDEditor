...
Module IscriptModule
    ...
    Public Sub readOpcodes()
        Dim filestream As New FileStream(My.Application.Info.DirectoryPath & "\Data\AnimOpcodes.txt", FileMode.Open)
    ...
    Public Class CIscript
                ...
                If currentHeader <> 0 Then
                    ...
                    Select Case opcode
                        ...
                        Case &H4
                            ...
                            DatEditForm.drawImageGRP(GetFrameNum, turnStatus, x, y)
                        Case &H5
                            DatEditForm.iscirpt_wait = values(0)
                        ...
                        Case &H6
                            ...
                            DatEditForm.iscirpt_wait = selectv
                        ...
                        Case &HE
                            ...
                            End If
                        Case &H13
                            'If DatEditDATA(DTYPE.images).ReadValue("Attack Overlay", DatEditForm._OBJECTNUM) = 0 Then
                            '    DatEditForm.IScriptPlayer.Enabled = False
                            '    DatEditForm.ListBox9.SelectedIndex = -1
                        ...
                        Case &H1F 'turnccwise
                            ...
                            Dim value As Integer = DatEditForm.TrackBar1.Value - values(0)

                            If value < 0 Then
                                DatEditForm.TrackBar1.Value = 33 + value
                            Else
                        ...
                        Case &H20
                            ...
                            If value > 33 Then
                                DatEditForm.TrackBar1.Value = value - 33
                            Else
                                DatEditForm.TrackBar1.Value = value
                            End If
                        Case &H21
                            Dim value As Integer = DatEditForm.TrackBar1.Value + 1
                        ...
                        Case &H22
                            ...
                            If selectv = 0 Then
                                value = DatEditForm.TrackBar1.Value + values(0)
                            Else
                                value = DatEditForm.TrackBar1.Value - values(0)
                            End If
        ...
        Private Function GetFrameNum()
            Dim ReturnFrame As Integer
            If gfxturn = True Then
                If DatEditForm.iscirpt_direction > 16 Then
                    ReturnFrame = currentFrame + 33 - DatEditForm.iscirpt_direction

                    turnStatus = True
                Else
                    ReturnFrame = currentFrame + DatEditForm.iscirpt_direction
