...
Module UpdateModule
    ...
    Public Function GetPatchNote() As String
        ...
        Try
            Download("https://github.com/iDoodler/EUDEditor/raw/master/version/PatchNote", "\Data\temp\PatchNote")
    ...
    Public Function CheckUpdateAble() As Boolean
        Try
            Download("https://github.com/iDoodler/EUDEditor/raw/master/version/version", "\Data\temp\Lastversion")
