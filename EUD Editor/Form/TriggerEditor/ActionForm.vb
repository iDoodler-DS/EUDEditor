...
Public Class ActionForm
    ...
    Public isNewAct As Boolean = False
        ...
        If m.Msg = WM_HOTKEY Then
            ...
            Select Case (id.ToString)
                ...
                Case "200"
                    ...
                    End If
                Case "300"
                    If _ele.act.ValuesDef.Count <> 0 And _ele.act.ValuesDef(0) <> "None" Then
    ...
    Private Function CheckValue() As Boolean
        If _ele.act.ValuesDef.Count = 0 Then
            SetSize(True)
            Button5.Enabled = True
            Return True
        Else
            If _ele.act.ValuesDef(0) = "None" Then
                SetSize(True)
                Button5.Enabled = True
                Return True
            End If
        ...
        For i = 0 To _ele.act.ValuesDef.Count - 1
            If _ele.Values(i) = _ele.act.ValuesDef(i) Then
    ...
    Private Sub ActionForm_Closed(sender As Object, e As EventArgs) Handles MyBase.FormClosed
        SetSize(False)
    End Sub
    ...
    Private Sub LoadCombobox(isfirst As Boolean)
        ...
        For i = 0 To Actions.Count - 1
            ...
            If Actions(i).Name = "EUDPart" Then
                startEUDPart = i
                '텝을 눌렀을 경우
                ...
                End If
            End If
            If Actions(i).Name = "STRUCTPart" Then
                startSTRUCTPart = i
                '텝을 눌렀을 경우
                ...
                End If
            End If
            If Actions(i).Name = "CUSTOMPart" Then
                startCUSTOMPart = i
            ...
            If trashfillter = False Then
                ComboBox3.Items.Add(Actions(i).Name)
            End If
    ...
    Private Sub ActionForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        isload = False
    ...
    Private Sub ComboBox3_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox3.SelectedIndexChanged
        ...
        End If
    End Sub
    Private Sub LoadAction(_index As Integer)
        Select Case TabControl2.SelectedIndex
            Case 0
        ...
        _ele.act = Actions(_index)


        _ele.Values = New List(Of String)
        For i = 0 To _ele.act.ValuesDef.Count - 1
            _ele.Values.Add(_ele.act.ValuesDef(i))
        Next
        MakeLable()
    End Sub
    ...
    Private Function GetValue() As String
        ...
        'Return _ele.Values(_ele.Act.ValuesDef.IndexOf(currentValueDef))
    End Function
    Private Sub SetValue(_value As String)
        _ele.SetValueTodef(currentValueDef, _value)
        '_ele.Values(_ele.Act.ValuesDef.IndexOf(currentValueDef)) = _value
    End Sub
