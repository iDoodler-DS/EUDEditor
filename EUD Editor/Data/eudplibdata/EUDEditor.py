...
def onPluginStart():
    ...
    cv5offset = f_epdread_epd(EPD(0x6D5EC8))
    vr4offset = f_epdread_epd(EPD(0x628444))
    vx4offset = f_epdread_epd(EPD(0x628458))
    DoActions([
    ])
    DoActions([
       SetMemory(0x661714, Add, 23296),
       SetMemory(0x65740C, Subtract, 436207616),
       SetMemory(0x65671C, Add, 83886080),
       SetMemory(0x656EFC, Subtract, 1310720),
       SetMemory(0x656504, Add, 16777216),
       SetMemory(0x669FA4, Subtract, 1),
       SetMemory(0x669FA4, Subtract, 256),
       SetMemory(0x669FA4, Subtract, 65536),
       SetMemory(0x66A1E0, Add, 655360),
       SetMemory(0x66A1E0, Subtract, 33554432),
       SetMemory(0x66F238, Subtract, 54),
       SetMemory(0x66F23C, Subtract, 54),
       SetMemory(0x66F240, Subtract, 54),
       SetMemory(0x66FB34, Subtract, 25),
       SetMemory(0x58D740, SetTo, 0x514178),
    ])

def beforeTriggerExec():
    DoActions([
       SetMemory(0x660A70 + 0, SetTo, 524290),
       SetMemory(0x660A70 + 4, SetTo, 1441808),
       SetMemory(0x660A70 + 8, SetTo, 1900544),
       SetMemory(0x660A70 + 12, SetTo, 2424832),
       SetMemory(0x660A70 + 16, SetTo, 3211307),
       SetMemory(0x660A70 + 20, SetTo, 3801088),
       SetMemory(0x660A70 + 24, SetTo, 66),
       SetMemory(0x660A70 + 28, SetTo, 75),
       ...
       SetMemory(0x660A70 + 64, SetTo, 81),
       SetMemory(0x660A70 + 68, SetTo, 88),
       SetMemory(0x660A70 + 72, SetTo, 6291456),
       SetMemory(0x660A70 + 76, SetTo, 6946917),
       SetMemory(0x660A70 + 80, SetTo, 7274496),
       SetMemory(0x660A70 + 84, SetTo, 7798899),
       SetMemory(0x660A70 + 88, SetTo, 8650879),
       SetMemory(0x660A70 + 92, SetTo, 9306249),
       ...
       SetMemory(0x660A70 + 116, SetTo, 155),
       SetMemory(0x660A70 + 120, SetTo, 11141285),
       SetMemory(0x660A70 + 124, SetTo, 176),
       SetMemory(0x660A70 + 128, SetTo, 12255414),
       SetMemory(0x660A70 + 132, SetTo, 12845247),
       SetMemory(0x660A70 + 136, SetTo, 13172736),
       SetMemory(0x660A70 + 140, SetTo, 13697229),
       SetMemory(0x660A70 + 144, SetTo, 14352598),
       SetMemory(0x660A70 + 148, SetTo, 0),
       SetMemory(0x660A70 + 152, SetTo, 0),
       SetMemory(0x660A70 + 156, SetTo, 0),
       SetMemory(0x660A70 + 160, SetTo, 0),
       SetMemory(0x660A70 + 164, SetTo, 14876672),
       SetMemory(0x660A70 + 168, SetTo, 15532264),
       ...
       SetMemory(0x660A70 + 204, SetTo, 16056320),
       SetMemory(0x660A70 + 208, SetTo, 0),
       SetMemory(0x660A70 + 212, SetTo, 16843004),
       SetMemory(0x660A70 + 216, SetTo, 17760520),
       SetMemory(0x660A70 + 220, SetTo, 18415892),
       SetMemory(0x660A70 + 224, SetTo, 19202335),
       SetMemory(0x660A70 + 228, SetTo, 19988779),
       SetMemory(0x660A70 + 232, SetTo, 20775223),
       SetMemory(0x660A70 + 236, SetTo, 323),
       SetMemory(0x660A70 + 240, SetTo, 329),
       SetMemory(0x660A70 + 244, SetTo, 22348111),
       SetMemory(0x660A70 + 248, SetTo, 23134555),
       SetMemory(0x660A70 + 252, SetTo, 0),
       SetMemory(0x660A70 + 256, SetTo, 0),
       SetMemory(0x660A70 + 260, SetTo, 23527424),
       SetMemory(0x660A70 + 264, SetTo, 24248684),
       SetMemory(0x660A70 + 268, SetTo, 25035128),
       SetMemory(0x660A70 + 272, SetTo, 25821572),
       SetMemory(0x660A70 + 276, SetTo, 26804624),
       SetMemory(0x660A70 + 280, SetTo, 27984293),
       SetMemory(0x660A70 + 284, SetTo, 29360564),
       SetMemory(0x660A70 + 288, SetTo, 453),
       SetMemory(0x660A70 + 292, SetTo, 458),
       SetMemory(0x660A70 + 296, SetTo, 30343168),
       SetMemory(0x660A70 + 300, SetTo, 0),
       SetMemory(0x660A70 + 304, SetTo, 0),
       SetMemory(0x660A70 + 308, SetTo, 30867923),
       SetMemory(0x660A70 + 312, SetTo, 31457756),
       SetMemory(0x660A70 + 316, SetTo, 31719424),
       SetMemory(0x660A70 + 320, SetTo, 489),
       SetMemory(0x660A70 + 324, SetTo, 32702958),
       SetMemory(0x660A70 + 328, SetTo, 33358328),
       SetMemory(0x660A70 + 332, SetTo, 34013698),
       SetMemory(0x660A70 + 336, SetTo, 34340864),
       SetMemory(0x660A70 + 340, SetTo, 35062289),
       SetMemory(0x660A70 + 344, SetTo, 540),
       ...
       SetMemory(0x6562F8 + 0, SetTo, 1179650),
       SetMemory(0x6562F8 + 4, SetTo, 3080229),
       SetMemory(0x6562F8 + 8, SetTo, 4063290),
       SetMemory(0x6562F8 + 12, SetTo, 5570638),
       SetMemory(0x6562F8 + 16, SetTo, 7274591),
       SetMemory(0x6562F8 + 20, SetTo, 9371769),
       SetMemory(0x6562F8 + 24, SetTo, 11862190),
       SetMemory(0x6562F8 + 28, SetTo, 13041855),
       SetMemory(0x6562F8 + 32, SetTo, 14876882),
       SetMemory(0x6562F8 + 36, SetTo, 16253169),
       SetMemory(0x6562F8 + 40, SetTo, 17760517),
       SetMemory(0x6562F8 + 44, SetTo, 19071257),
       SetMemory(0x6562F8 + 48, SetTo, 19661095),
       SetMemory(0x6562F8 + 52, SetTo, 20316160),
       SetMemory(0x6562F8 + 56, SetTo, 20971835),
       SetMemory(0x6562F8 + 60, SetTo, 21561668),
       SetMemory(0x6562F8 + 64, SetTo, 334),
       SetMemory(0x6562F8 + 68, SetTo, 340),
